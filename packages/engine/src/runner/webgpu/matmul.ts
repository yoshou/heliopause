...
import type { WebGpuBufferLike, WebGpuComputePassLike, WebGpuDeviceLike, WebGpuF32TensorHandle, WebGpuF32TensorHandleInternal, WebGpuGatedDeltaNetResult, WebGpuQkvConvResult, WebGpuQuantizedWeightHandle, WebGpuQuantizedWeightHandleInternal, WebGpuTopToken } from "./gpu-types";
