...
const MODEL = {
  path: "models/gemma4/unsloth-12b/gemma-4-12b-it-Q4_K_M.gguf",
  size: 7_121_860_000,
  sha256: "5e6cf45aecd660fc1352c3b86d0c7fc34e5d7d17db2466ed7a40d19ad9a62626",
};
...
Deno.test({
  name: "Gemma 4 12B GGUF WebGPU e2e generates natural text with sliding KV ring cache",
  sanitizeOps: false,
